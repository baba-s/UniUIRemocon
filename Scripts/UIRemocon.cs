...
namespace Kogane.Internal
{
	...
	internal sealed class UIRemocon : MonoBehaviour
	{
		//==============================================================================
		// 定数
		//==============================================================================
		...
		[SerializeField] private Text[]           m_speedTextUIList   = default;
		[SerializeField] private SelectButtonUI[] m_speedButtonUIList = default;
